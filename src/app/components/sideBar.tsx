...
const SideBar= ({isSidebarOpen, toggleSidebar}: SidebarProps) => {
  return (
    <div className="bg-zinc-800 h-full p-4 w-[20%] rounded-r-[10px]">
        {isSidebarOpen? 
          <div className="flex justify-between">
              <ToggleButton isOpen={isSidebarOpen} toggleSidebar={toggleSidebar} className="hover:bg-zinc-600 rounded-md p-2"/>
